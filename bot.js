...
client.on('ready',  () => {
    console.log('تم تشغيل : Crazy World  ');
...
client.on('message', message => {
    ...
    .setAuthor("[ CrazyWorld Bot ]", " https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455")
    .addField("**[ CrazyWorld Prefix] :**","**[ * ]**" , true)
    .addField("** [ CrazyWorld ID ] **", "**"*"509312763856683010"*"**",true)
    .addField("** [ CrazyWorld ] **","**crazy**")
    .addField("**[ Bot Developer ]**","<@!498132773878628353>]")
    ...
    .setColor("ffffff")
    .setFooter(`*help to see all CrazyWorld commands `, ' https://images-ext-2.discordapp.net/external/ahNXTY5REo9rE5-6oa5XGyzSrJis3qbk7eBUv1sEiYI/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/459725014237970492/558a210e07b9ae2504e427a4c7c6d297.png?width=455&height=455')
    message.channel.sendEmbed(embed)
    }
    });

client.on("guildDelete", guild => {
    console.log(` CrazyWorld Left From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                   ...
                   .setColor("RANDOM")
                .setFooter(` ©  CrazyWorldt™ `)
                .setTitle(" CrazyWorld Left Server !")
...
console.log(` CrazyWorld Added From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
...
const embed = new Discord.RichEmbed()
                ...
                .setTitle(" CrazyWorld Added To Server !")
                .addField("**Guild Name:**", guild.name )
                 .addField("**Owner:**", guild.owner.user.username )
                 .addField("**MEMBER COUNT:**", g )
                  .setThumbnail (i)
